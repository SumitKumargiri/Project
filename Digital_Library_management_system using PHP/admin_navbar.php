    ...
    if(isset($_SESSION['login_admin_username']))
    {
        ...
        <div class="container">
            <div class="navbar">
                ...
                <a href="index.php"><h3 style="font-size: 16px;">Digital Library Management System</h3></a>
                </div>
    ...
    else
    {
        ...
        <div class="container">
            <div class="navbar">
                ...
                <div class="title">
                <a href="index.php"><h3 style="font-size: 20px;">Digital Library Management System</h3></a>
                </div>
                <nav>
                    <ul id="menuitems">
